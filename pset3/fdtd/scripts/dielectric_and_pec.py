...
# Add a PEC.
corners = (x_len // 6, x_len // 3, 3 * y_len // 8, 5 * y_len // 8)
sim.add_pec(
    uses_physical_coordinates=False, geometry="rectangular", box_corners=corners
)
...
save_path = os.path.join(DATA_PATH, "dielectric_and_pec.npz")
sim.write(save_path)
